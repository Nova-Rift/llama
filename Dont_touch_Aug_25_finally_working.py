...
#     del accuracy_list, lists1, lists2, output, X, y, outing, list1, list2
...
#         outing = (output >= 0.5).float().detach()

#         # Calculate accuracy without transferring to CPU
#         accuracy_list.append(accuracy(outing, y))

#         # Free up CUDA memory
#         del X, output

#         if epoch != EPOCHS - 1:  # If it's not the last epoch
#             del y, outing

#     # Use mean function to get average accuracy
#     print(f'Accuracy = {sum(accuracy_list) / len(accuracy_list)}')

#     print('perc', 'pred', 'true')
#     for l1, l2, l3 in zip(outing.cpu().tolist(), outing.cpu().tolist(), y.cpu().tolist()):
#         print(l1, l2, l3)

#     # Free up CUDA memory after the prints
#     del outing, y
